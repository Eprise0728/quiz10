...
public class Quiz {
	...
	@NotBlank(message = "Quiz name cannot be null empty")
	@Column(name = "name")
	private String name;
	
	@NotBlank(message = "Description cannot be null empty")
	@Column(name = "description")
	private String description;
	
	@FutureOrPresent(message = "Start date must be in present or in the future")
	@NotNull(message = "Start date cannot be null empty")
	@Column(name = "start_date")
	private LocalDate startDate;
	
	@FutureOrPresent(message = "End date must be in present or in the future")
	@NotNull(message = "end date cannot be null empty")
